...
/**
 * A class representing an item listing for a household good such as a piece of furniture,
 * decoration, appliance, etc.
 */
public class HouseholdGoodsListing extends ItemListing implements Serializable {
    private int weight;

    /**
     * A constructor to create an item listing for a household good.
     ...
     * @param weight The weight of the household good for sale in pounds.
     ...
     */
    public HouseholdGoodsListing(String seller, String title, float price, int weight,
                                 String condition, String deliveryMethod, String description) {
        super(seller, title, price, condition, deliveryMethod, description);
        super.category = "Household Goods";
        this.weight = weight;
    }

    /**
     * A method which displays information about a HouseholdGoodsListing object.
     * @return A String which contains information about an HouseholdGoodsListing object.
     */
    @Override
     ...
     * class which calculates the cost to ship a household good.
     * @return A float representing the cost to ship a household good.
     */
    @Override
    public float calculateShippingCost() {
        ...
        // The shipping cost is set to -1 for household goods which are not available for shipping.
        else shippingCost = -1;
        return shippingCost;
    }
